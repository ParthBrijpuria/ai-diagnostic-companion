#!/usr/bin/env python3
"""
Quick MRI prediction using the improved ensemble model
"""
...
def main():
    if len(sys.argv) != 2:
        print(json.dumps({"error": "Usage: python mri_quick_predict.py <image_path>"}))
        sys.exit(1)
    ...
    try:
        # Load model
        model_data = joblib.load('models/mri/mri_quick_model.pkl')
