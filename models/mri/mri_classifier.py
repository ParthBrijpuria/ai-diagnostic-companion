...
class MRITumorClassifier:
    ...
    def train(self, max_images_per_class=300):
...
def main():
    ...
    results, final_accuracy = classifier.train(max_images_per_class=200)
    ...
    for class_name in classifier.classes:
        ...
        if os.path.exists(class_dir):
            sample_files = [f for f in os.listdir(class_dir) if f.lower().endswith(('.jpg', '.jpeg', '.png'))][:3]
            ...
            for sample_file in sample_files:
                ...
                try:
                    ...
                    print(f"  {sample_file}: {prediction['predicted_class']} (confidence: {prediction['confidence']:.3f})")
                except Exception as e:
