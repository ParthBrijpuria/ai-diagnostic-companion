#!/usr/bin/env python3
"""
Enhanced MRI Brain Tumor Classification Model
...
class EnhancedMRIClassifier:
    def __init__(self, model_path='mri_enhanced_model.pkl', dataset_path='datasets/mri scan'):
        self.model = None
    ...
    def train_enhanced_model(self, max_images_per_class=1000):
        """Train enhanced ensemble model"""
        logger.info("Training enhanced MRI classification model...")
        
        # Load training data
        train_images, train_labels = self._load_and_preprocess_images(
            os.path.join(self.dataset_path, 'Training'), max_images_per_class
        )
...
def main():
    """Main function to train and evaluate the enhanced MRI model"""
    classifier = EnhancedMRIClassifier()
    
    # Train the model
    logger.info("Training enhanced MRI classification model...")
    training_accuracy = classifier.train_enhanced_model(max_images_per_class=1000)
    logger.info(f"Training Accuracy: {training_accuracy:.4f} ({training_accuracy*100:.2f}%)")
    
    # Evaluate on the test set
    logger.info("Evaluating model on test set...")
    test_accuracy, class_wise_accuracy = classifier.evaluate('datasets/mri scan/Testing')
