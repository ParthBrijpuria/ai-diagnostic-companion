#!/usr/bin/env python3
"""
Improved X-ray Pneumonia Classification Model V2
Fixes feature extraction and improves accuracy
"""
...
class ImprovedXRayClassifierV2:
    def __init__(self, model_path='xray_improved_v2_model.pkl', dataset_path='datasets/chest_xray'):
        self.model = None
    ...
    def train_improved_model(self, max_images_per_class=1500):
        """Train improved model with better algorithms"""
        logger.info("Training improved X-ray classification model...")
        ...
        models = {
            ...
            'GradientBoosting': GradientBoostingClassifier(n_estimators=300, learning_rate=0.05, max_depth=15, random_state=42),
            'ExtraTrees': ExtraTreesClassifier(n_estimators=300, max_depth=25, random_state=42),
...
def main():
    """Main function"""
    classifier = ImprovedXRayClassifierV2()
    
    # Train model
    training_accuracy = classifier.train_improved_model(max_images_per_class=1500)
